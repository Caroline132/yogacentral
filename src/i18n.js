...
const resources = {
  en: {
    translation: {
      ...
      a1:"No, YogaCentral is built around portability. You can just build a sequence and then start flowing. If you would like to add a yoga mat for comfort, that could be useful. Also, for beginners, you could buy a block to help with more challenging poses.",
      q2:"Where should you start?",
      a2_1:"If you are new to yoga, start by selecting an easy sequence that is short in length, and you can choose any goal you want.",
      ...
      a3_2:"The yoga sessions are 30 minutes long, and you select the format. You can choose a nice flow (to relax, energize, stretch, etc.), or you can get help on certain postures.",
      ...
      a4:"Our classes are 100% free! We aim to provide free yoga and meditation classes to individuals. We believe there's a great need for such services, and offering them for free is crucial for them to be accessible.",
  ...
  fr: {
    translation: {
        ...
        blogAuthorError:"Veuillez fournir un auteur valide.",
        blogTitleError:"Veuillez fournir un titre valide.",
        blogContentError:"Veuillez fournir du contenu.",
        namePH:"Nom",
        emailPH:"E-mail",
